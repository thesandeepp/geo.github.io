...
function setButtonCoordinates() {
  if (window.innerWidth <= 700) {
    const buttonCoordinatesMobile = [
      { top: "196px", left: "191px" },
      { top: "130px", left: "221px" }, 
      { top: "194px", left: "160px" },
      { top: "122px", left: "180px" },
      { top: "62px", left: "190px" },
      { top: "172px", left: "220px" },
    ...
    const buttonCoordinates = [
      { top: "285px", left: "281px" },
      { top: "230px", left: "251px" }, 
      { top: "290px", left: "230px" },
      { top: "192px", left: "250px" },
      { top: "92px", left: "280px" },
      { top: "242px", left: "320px" },
