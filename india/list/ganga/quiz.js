...
function setButtonCoordinates() {
  if (window.innerWidth <= 700) {
    const buttonCoordinatesMobile = [
      { top: "151px", left: "131px" },
      { top: "153px", left: "221px" }, 
      { top: "200px", left: "220px" },
      { top: "142px", left: "160px" },
      { top: "152px", left: "190px" },
      { top: "182px", left: "200px" },
      { top: "232px", left: "270px" },
      { top: "180px", left: "130px" },
      { top: "182px", left: "255px" },
    ...
    const buttonCoordinates = [
      { top: "218px", left: "191px" },
      { top: "243px", left: "321px" }, 
      { top: "290px", left: "320px" },
      { top: "202px", left: "230px" },
      { top: "232px", left: "280px" },
      { top: "262px", left: "290px" },
      { top: "332px", left: "390px" },
      { top: "260px", left: "190px" },
      { top: "262px", left: "370px" },
